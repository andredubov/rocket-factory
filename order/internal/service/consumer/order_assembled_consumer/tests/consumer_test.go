...
import (
	...
	"github.com/andredubov/rocket-factory/order/internal/service/consumer/order_assembled_consumer"
...
func TestNewService(t *testing.T) {
	...
	service := order_assembled_consumer.NewService(mockConsumer, mockDecoder, mockRepo)
