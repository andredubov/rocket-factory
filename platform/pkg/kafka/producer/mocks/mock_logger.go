...
func (_m *Logger) Error(ctx context.Context, msg string, fields ...zap.Field) {
...
func (_c *Logger_Error_Call) Run(run func(ctx context.Context, msg string, fields ...zap.Field)) *Logger_Error_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]zap.Field, len(args)-2)
...
func (_c *Logger_Error_Call) RunAndReturn(run func(context.Context, string, ...zap.Field)) *Logger_Error_Call {
	_c.Run(run)
	return _c
}

// Info provides a mock function with given fields: ctx, msg, fields
func (_m *Logger) Info(ctx context.Context, msg string, fields ...zap.Field) {
	_va := make([]interface{}, len(fields))
	for _i := range fields {
		_va[_i] = fields[_i]
	}
...
func (_c *Logger_Info_Call) Run(run func(ctx context.Context, msg string, fields ...zap.Field)) *Logger_Info_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]zap.Field, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *Logger_Info_Call) RunAndReturn(run func(context.Context, string, ...zap.Field)) *Logger_Info_Call {
	_c.Run(run)
	return _c
}
